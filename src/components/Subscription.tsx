        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden relative z-10 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-blue-50">
            <div className="p-8">
              ...
              <a
                href="https://pay.cakto.com.br/ieFcYbH?test=true"
                target="_blank"
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.open("https://pay.cakto.com.br/ieFcYbH?test=true", "_blank", "noopener,noreferrer");
                }}
              >
                Assinar Agora
              </a>
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden transform scale-105 relative z-20 border-2 border-blue-200">
            ...
            <div className="p-8">
              ...
              <a
                href="https://pay.cakto.com.br/4w9c257_340495?test=true"
                target="_blank"
                rel="noopener noreferrer"
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.open("https://pay.cakto.com.br/4w9c257_340495?test=true", "_blank", "noopener,noreferrer");
                }}
              >
                Assinar Agora
              </a>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden relative z-10 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-blue-50">
            <div className="p-8">
              ...
              <a
                href="https://pay.cakto.com.br/6zmuxcz_340499?test=true"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-3 px-4 bg-gradient-to-r from-green-600 to-green-500 text-white rounded-lg hover:from-green-700 hover:to-green-600 transform transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl font-medium"
                onClick={(e) => {
                  e.preventDefault();
                  window.open("https://pay.cakto.com.br/6zmuxcz_340499?test=true", "_blank", "noopener,noreferrer");
                }}
              >
                Assinar Agora
              </a>
            ...
            <div className="text-yellow-800 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <p className="text-sm">4000 0000 0000 0002</p>
                  <p className="text-xs text-gray-600">Qualquer data futura e CVV</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                  <p className="font-bold">Erro de Processamento</p>
                  <p className="text-sm">4000 0000 0000 0119</p>
                  <p className="text-xs text-gray-600">Qualquer data futura e CVV</p>
                </div>
              </div>
            </div>
